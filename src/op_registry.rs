...
pub mod op_types {
    ...
    declare_op!(BlackmanWindow, onnx_only);
    declare_op!(Cast);
    declare_op!(CastLike);
    declare_op!(Ceil);
    declare_op!(Celu, onnx_only);
    declare_op!(Clip);
    declare_op!(Compress, onnx_only);
    declare_op!(Concat);
    ...
    declare_op!(GlobalLpPool, onnx_only);
    declare_op!(Greater);
    ...
    declare_op!(SpaceToDepth, onnx_only);
    declare_op!(Split);
    ...
    declare_op!(Tan);
    declare_op!(Tanh);
    declare_op!(ThresholdedRelu, onnx_only);
    declare_op!(Tile);
    declare_op!(TopK);
