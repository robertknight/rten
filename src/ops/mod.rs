...
pub use unary_elementwise::{
    ...
    floor_in_place, leaky_relu, leaky_relu_in_place, log, log_in_place, not, not_in_place, relu,
    relu_in_place, round, round_in_place, sigmoid, sigmoid_in_place, sin, sin_in_place, sqrt,
    sqrt_in_place, tanh, tanh_in_place, Abs, Ceil, Clip, Cos, Erf, Floor, LeakyRelu, Log, Not,
    Relu, Round, Sigmoid, Sin, Sqrt, Tanh,
};
