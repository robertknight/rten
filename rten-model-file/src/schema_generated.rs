...
pub const ENUM_MAX_OPERATOR_TYPE: u8 = 166;
#[deprecated(
    since = "2.0.0",
    note = "Use associated constants instead. This will no longer be generated in 2021."
)]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_OPERATOR_TYPE: [OperatorType; 167] = [
    OperatorType::Add,
    OperatorType::ArgMin,
    OperatorType::ArgMax,
...
impl OperatorType {
    ...
    pub const BitwiseNot: Self = Self(151);
    pub const BitwiseAnd: Self = Self(152);
    pub const BitwiseOr: Self = Self(153);
    pub const BitwiseXor: Self = Self(154);
    pub const BitShift: Self = Self(155);
    ...
    pub const BlackmanWindow: Self = Self(166);
    ...
    pub fn variant_name(self) -> Option<&'static str> {
        match self {
            ...
            Self::BlackmanWindow => Some("BlackmanWindow"),
            _ => None,
        }
    }
}
...
pub const ENUM_MAX_OPERATOR_ATTRS: u8 = 71;
#[deprecated(
    since = "2.0.0",
    note = "Use associated constants instead. This will no longer be generated in 2021."
)]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_OPERATOR_ATTRS: [OperatorAttrs; 72] = [
    OperatorAttrs::NONE,
...
impl OperatorAttrs {
    ...
    pub const SpaceToDepthAttrs: Self = Self(68);
    pub const CompressAttrs: Self = Self(69);
    pub const BernoulliAttrs: Self = Self(70);
    pub const HannWindowAttrs: Self = Self(71);
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> AveragePoolAttrsBuilder<'a, 'b, A> {
    ...
    pub fn add_strides(
        &mut self,
        strides: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b, u32>>,
    ) {
        self.fbb_
...
pub enum LoopAttrsOffset {}
#[derive(Copy, Clone, PartialEq)]

pub struct LoopAttrs<'a> {
    pub _tab: ::flatbuffers::Table<'a>,
}

impl<'a> ::flatbuffers::Follow<'a> for LoopAttrs<'a> {
    type Inner = LoopAttrs<'a>;
    #[inline]
    unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
        Self {
            _tab: unsafe { ::flatbuffers::Table::new(buf, loc) },
...
impl<'a> LoopAttrs<'a> {
    ...
    >(
        _fbb: &'mut_bldr mut ::flatbuffers::FlatBufferBuilder<'bldr, A>,
        args: &'args LoopAttrsArgs<'args>,
    ) -> ::flatbuffers::WIPOffset<LoopAttrs<'bldr>> {
        let mut builder = LoopAttrsBuilder::new(_fbb);
    ...
    pub fn body(&self) -> Option<Graph<'a>> {
        ...
        unsafe {
            self._tab
                .get::<::flatbuffers::ForwardsUOffset<Graph>>(LoopAttrs::VT_BODY, None)
        }
    }
}

impl ::flatbuffers::Verifiable for LoopAttrs<'_> {
    #[inline]
    fn run_verifier(
        v: &mut ::flatbuffers::Verifier,
        pos: usize,
...
pub struct LoopAttrsArgs<'a> {
    pub body: Option<::flatbuffers::WIPOffset<Graph<'a>>>,
}
impl<'a> Default for LoopAttrsArgs<'a> {
    #[inline]
    fn default() -> Self {
        LoopAttrsArgs { body: None }
    }
}

pub struct LoopAttrsBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
    fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
    start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> LoopAttrsBuilder<'a, 'b, A> {
    #[inline]
    pub fn add_body(&mut self, body: ::flatbuffers::WIPOffset<Graph<'b>>) {
        self.fbb_
            .push_slot_always::<::flatbuffers::WIPOffset<Graph>>(LoopAttrs::VT_BODY, body);
    }
    #[inline]
    pub fn new(
        _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
    ) -> LoopAttrsBuilder<'a, 'b, A> {
        let start = _fbb.start_table();
        LoopAttrsBuilder {
            fbb_: _fbb,
            start_: start,
    ...
    #[inline]
    pub fn finish(self) -> ::flatbuffers::WIPOffset<LoopAttrs<'a>> {
        let o = self.fbb_.end_table(self.start_);
        ::flatbuffers::WIPOffset::new(o.value())
    }
}

impl ::core::fmt::Debug for LoopAttrs<'_> {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> IfAttrsBuilder<'a, 'b, A> {
    ...
    pub fn add_then_branch(&mut self, then_branch: ::flatbuffers::WIPOffset<Graph<'b>>) {
        self.fbb_
            .push_slot_always::<::flatbuffers::WIPOffset<Graph>>(
...
impl<'a> OperatorNode<'a> {
    ...
    pub fn attrs_as_loop_attrs(&self) -> Option<LoopAttrs<'a>> {
        if self.attrs_type() == OperatorAttrs::LoopAttrs {
            self.attrs().map(|t| {
                // Safety:
                // Created from a valid Table for this object
                // Which contains a valid union in this slot
                unsafe { LoopAttrs::init_from_table(t) }
            })
        } else {
            None
        }
...
impl<'a> ValueNode<'a> {
    ...
    pub fn shape(
        &self,
    ) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<Dim<'a>>>> {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe {
...
pub struct ValueNodeArgs<'a> {
    pub shape: Option<
        ::flatbuffers::WIPOffset<
            ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<Dim<'a>>>,
        >,
    >,
    pub dtype: Option<DataType>,
}
...
pub struct GraphArgs<'a> {
    pub nodes: Option<
        ::flatbuffers::WIPOffset<
            ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<Node<'a>>>,
        >,
    >,
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> GraphBuilder<'a, 'b, A> {
    ...
    pub fn add_captures(
        &mut self,
        captures: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b, u32>>,
    ) {
        self.fbb_
