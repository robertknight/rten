use std::arch::wasm32::{
    ...
    i32x4_trunc_sat_f32x4, i8x16_add, i8x16_eq, i8x16_ge, i8x16_gt, i8x16_narrow_i16x8, i8x16_neg,
    i8x16_shl, i8x16_splat, i8x16_sub, v128, v128_and, v128_bitselect, v128_load, v128_store,
};
...
unsafe impl SimdOps<I8x16> for Wasm32Isa {
    ...
    fn mul(self, x: I8x16, y: I8x16) -> I8x16 {
        let mul_low = i16x8_extmul_low_i8x16(x.0, y.0);
        let mul_high = i16x8_extmul_high_i8x16(x.0, y.0);
        I8x16(i8x16_narrow_i16x8(mul_low, mul_high))
    }
